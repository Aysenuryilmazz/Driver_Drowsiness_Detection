...
# -*- coding: utf-8 -*-
"""
Created on Thu May 14 00:11:21 2020
...
#define eye circularity function
...
#define level of eyebrows function(we found this feature)
...
#    processed_frames = []
    ...
    while True:
        ...
        #there is no face --> make feature values to indicate -1
        if len(rects) == 0:
            frame_info = {
                'subject': subject,
        ...
        #there is more than one face --> make feature values to indicate -1
        if len(rects) > 1:
            frame_info = {
                'subject': subject,
                'external_factors': external_factors,
...
######################## MAIN ######################################
# subjects=['031','032','033','034','035','036']
directory = "/Users/aysenur/Desktop/NTHU-DDD/Training_Evaluation_Dataset/Training_Dataset"
subjects=os.listdir(directory)
for subject in subjects:
    # directory = "/Users/aysenur/Desktop/NTHU-DDD/Training_Evaluation_Dataset/Training_Dataset/{}".format(subject)
    sub_folders = os.listdir(directory+'/'+subject)
    for sub_folder in sub_folders:
        #as we indicate before our PSD, we assume that driver does not wear sunglasses,
        #that's why we skip all videos with sunglasses
        ...
        for video_name in video_names:
            ...
            if extension=='.avi': 
                ...
                frame_info_df.to_pickle('./train/{}_{}_{}_frame_info_df.pkl'.format(subject,sub_folder,clean_name))
                video_info_dict.to_pickle('./train/{}_{}_{}_video_info_df.pkl'.format(subject,sub_folder,clean_name))
