...
def process_video(input_file, fold, subject, videoname, detector=dlib_detector, predictor=dlib_predictor, \
    ...
    if file[:4]=="Fold":
        ...
        for subject in subjects:
            ...
            for video_name in video_names:
                ...
                print(file_path)
                frame_info_df, video_info_dict = process_video(file_path, fold=fold[:5], subject=subject, videoname=clean_name, \
