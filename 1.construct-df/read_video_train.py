...
for subject in subjects:
    # directory = "C:/Users/hakko/Desktop/NTHU-DDD/Training_Evaluation_Dataset/Training Dataset/{}".format(subject)
...
# file_path="E:\DROWZEE\sunum\sleepyCombination_sample.mp4"
    
# frame_info_df, video_info_dict = process_video(file_path, subject='015', external_factors='glasses',facial_actions='nonsleepyCombination', \
#                                                                 ear_th=EAR_THRESHOLD, consec_th=EAR_CONSEC_FRAMES, skip_n=SKIP_FIRST_FRAMES)
# frame_info_df.to_pickle('./train/{}_{}_{}_frame_info_df.pkl'.format('015','glasses','nonsleepyCombination'))
# video_info_dict.to_pickle('./train/{}_{}_{}_video_info_df.pkl'.format('015','glasses','nonsleepyCombination'))
